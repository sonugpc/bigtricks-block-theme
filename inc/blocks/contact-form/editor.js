	...
	registerBlockType('bigtricks/contact-form', {
		edit: function(props) {
			...
			return el('div', blockProps,
				...
				el('div', { className: 'max-w-2xl mx-auto p-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300' },
					el('div', { className: 'text-center mb-4' },
						el('span', { className: 'dashicons dashicons-email text-4xl text-gray-400' })
					),
					...
					el('div', { className: 'bg-white p-6 rounded-lg border border-gray-200' },
						...
						el('div', { className: 'space-y-4' },
							el('div', {},
								el('label', { className: 'block text-sm font-semibold mb-2' }, 'Your Name *'),
								el('div', { className: 'border border-gray-300 rounded-lg px-4 py-3 bg-gray-50' }, 'Name field')
							),
							el('div', {},
								el('label', { className: 'block text-sm font-semibold mb-2' }, 'Email Address *'),
								el('div', { className: 'border border-gray-300 rounded-lg px-4 py-3 bg-gray-50' }, 'Email field')
							),
							el('div', {},
								el('label', { className: 'block text-sm font-semibold mb-2' }, 'WhatsApp Number'),
								el('div', { className: 'border border-gray-300 rounded-lg px-4 py-3 bg-gray-50' }, 'Phone field')
							),
							el('div', {},
								el('label', { className: 'block text-sm font-semibold mb-2' }, 'Your Message *'),
								el('div', { className: 'border border-gray-300 rounded-lg px-4 py-3 bg-gray-50 h-24' }, 'Message field')
							),
