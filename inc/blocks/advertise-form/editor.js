    ...
    edit: function (props) {
      ...
      return el(
        ...
        el(
          ...
          {
            className:
              "max-w-3xl mx-auto p-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300",
          },
          el(
            "div",
            { className: "text-center mb-4" },
            el("span", {
              className: "dashicons dashicons-megaphone text-4xl text-gray-400",
            }),
          ),
              ...
              el(
                ...
                el(
                  ...
                  el(
                    ...
                    {
                      className:
                        "border border-gray-300 rounded px-3 py-2 bg-gray-50 text-xs",
                    },
                    "Name",
                  ),
                  el(
              ...
              el(
                ...
                el(
                  ...
                  el(
                    ...
                    {
                      className:
                        "border border-gray-300 rounded px-3 py-2 bg-gray-50 h-16 text-xs",
                    },
                    "Message",
                  ),
                ),
