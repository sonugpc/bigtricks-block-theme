			...
			<div>
				...
				<div class="mb-2 flex items-center gap-2 flex-wrap">
					...
					<div class="flex items-center gap-1.5 text-xs font-bold text-slate-500 uppercase tracking-wider">
						...
						<a href="<?php echo $store_link; ?>" class="hover:text-indigo-600 transition-colors hover:underline"><?php echo esc_html( $store_name ); ?></a>
						<?php else : ?>
					...
					<?php endif; ?>
					<?php if ( $cat_name ) : ?>
					<div class="flex items-center gap-1 text-xs font-bold text-indigo-600 uppercase tracking-wider">
				...
				<h2 class="font-black text-slate-900 group-hover:text-indigo-600 leading-snug mb-2 transition-colors break-words text-lg sm:text-xl line-clamp-2">
				...
				<div class="flex items-baseline gap-3 mb-3">
					<?php if ( $sale_price ) : ?>
					<span class="text-2xl font-black text-indigo-600">₹<?php echo esc_html( $sale_price ); ?></span>
					<?php endif; ?>
