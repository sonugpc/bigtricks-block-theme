...
document.addEventListener('DOMContentLoaded', function() {
	...
	const forms = document.querySelectorAll('.bt-contact-form-element, .bt-advertise-form-element');
	...
	forms.forEach(function(form) {
		...
		form._cached = { submitButton, submitText, messagesContainer, originalText };
	...
	function handleFormSubmit(e) {
		...
		const { submitButton, submitText, messagesContainer, originalText } = form._cached;
